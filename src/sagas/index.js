...
import { CREATE_LISTING, MARK_LISTING_CLOSED } from "../actions/listings";
import {
  fetchUser,
  loginUser,
  lookupJWT,
...
import { createListing, markListingClosed } from "./listing";
...
export default function* rootSaga() {
  ...
  yield takeEvery(MARK_LISTING_CLOSED, markListingClosed);
